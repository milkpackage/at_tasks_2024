...
class BugReportPage(BasePage):
    def __init__(self, driver):
        ...
        # form elements
        self.category_select = Element(driver, By.CSS_SELECTOR, "[name='category_id']")
        self.reproducibility_select = Element(driver, By.CSS_SELECTOR, "[name='reproducibility']")
        self.severity_select = Element(driver, By.CSS_SELECTOR, "[name='severity']")
        self.priority_select = Element(driver, By.CSS_SELECTOR, "[name='priority']")
    ...
    def create_bug(self, summary, description, category="General",
        ...
        try:
            ...
            return self.is_bug_created_successfully()
